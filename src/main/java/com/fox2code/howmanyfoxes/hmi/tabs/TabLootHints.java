...
public class TabLootHints extends TabWithTexture {
    ...
    public float getChanceOf(ItemStack stack) {
        ...
        for(LootTableEntry entry : currentLoot.lootTable.getLootTableEntries()) {
            if(entry.getItemStack().getItemDamage() == stack.getItemDamage() && entry.getItemStack().getItemID() == stack.getItemID()) {
                return Math.round(entry.getDropChance() * 100.0f);
            }
        }
    ...
    public static FancyPackedLoot[] fetchKnownLootDetails() {
        ...
        data[2] = new FancyPackedLoot(
                ...
                new LootTable(
                        new LootTableEntry(new ItemStack(Items.STICKY_TORCH), fixed1p13chance, 1, 7),
                        new LootTableEntry(new ItemStack(Items.GOLD_INGOT), fixed1p13chance, 1, 4),
                        new LootTableEntry(new ItemStack(Items.DYNAMITE), fixed1p13chance, 1, 4),
                        new LootTableEntry(new ItemStack(Items.EMPTY_BUCKET), fixed1p13chance),
                        new LootTableEntry(new ItemStack(Items.POTION), fixed1p13chance),
                        new LootTableEntry(new ItemStack(Items.CHAINMAIL_HELMET), fixed1p13chance * 1/4),
                        new LootTableEntry(new ItemStack(Items.CHAINMAIL_CHESTPLATE), fixed1p13chance * 1/4),
                        new LootTableEntry(new ItemStack(Items.CHAINMAIL_LEGGINGS), fixed1p13chance * 1/4),
                        new LootTableEntry(new ItemStack(Items.CHAINMAIL_BOOTS), fixed1p13chance * 1/4),
                        new LootTableEntry(new ItemStack(Items.THIRTEEN_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.CAT_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.BLOCKS_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.CHIRP_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.FAR_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.MALL_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.MELLOHI_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.STAL_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.STRAD_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.WARD_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.ELEVEN_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.WAIT_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.DOG_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.FAE_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.FROZEN_RECORD), fixed1p13chance * 1/15),
                        new LootTableEntry(new ItemStack(Items.IRON_INGOT), fixed1p13chance, 1, 4),
                        new LootTableEntry(new ItemStack(Items.WHEAT), fixed1p13chance, 1, 5),
                        new LootTableEntry(new ItemStack(Items.GUNPOWDER), fixed1p13chance, 1, 5),
                        new LootTableEntry(new ItemStack(Items.BREAD), fixed1p13chance, 1, 4),
                        new LootTableEntry(new ItemStack(Blocks.SPONGE), fixed1p13chance, 1, 7),
                        new LootTableEntry(new ItemStack(Items.SADDLE), fixed1p13chance)
                )
        );
    ...
    public static TabLootHints tooltipHelper(GuiScreen screen) {
        if (screen instanceof GuiRecipeViewer viewer) {
            Object o = GuiRecipeViewer.tabs.get(viewer.tabIndex);
            if(o instanceof TabLootHints tab) {
                return tab;
            }
        }
        return null;
